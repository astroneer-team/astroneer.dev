export default function Button({ children }: { children: React.ReactNode }) {
  ...
  return (
    <button className="relative rounded-md child:hover:before:opacity-100">
      <div className="before:opacity-0 before:h-[calc(100%+2px)] before:w-[calc(100%+2px)] before:animate-spin-spiral before:duration-500 before:absolute before:z-[-1] before:bg-spiral-highlight before:rounded-md before:-left-px before:-top-px before:transition-all">
